=head1 OpenAFS Newsletter, Issue 7, November 2009
...
L<http://gerrit.openafs.org> and login using your OpenID
...
=head4 DNS SRV Resource Records for AFS
...
=head3 Active Directory Backend for Ptserver
